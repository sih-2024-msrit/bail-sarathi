...
const {createApplication,testFlask, bailSummary, getLawyerBail,testChatBot, getJudgeBail, changeStatus}=require('../controllers/bailout')
const router = Router();
...
router.route("/status-change").post(changeStatus);
