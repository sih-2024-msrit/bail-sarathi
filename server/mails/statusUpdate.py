def generate_status_update(status, application_no, judge_license):
...
<body>
  <div class="container">
    ...
    <div class="body">
      <p>Dear User,</p>
      <p>We are writing to inform you about the status of your bail application (Application No: <span class="highlight">{application_no}</span>).</p>
      <p><strong>Status:</strong> {status}</p>
      <p>Your application has been reviewed by Judge (License No: <span class="highlight">{judge_license}</span>).</p>
